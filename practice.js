...
function printIngredients(recipe, pieQuantity, pieType) {
...
function printCosts(recipe, pieQuantity) {
...
function calculateCosts(costOfPie, pieQuantity, profitMargin) {
...
function bakeAndSellPies(pieType, pieQuantity, profitMargin) {
  ...
  printIngredients(recipe, pieQuantity, pieType);
  let costOfPie = printCosts(recipe)
  console.log(`Cost per pie: ${costOfPie}`);
  calculateCosts(costOfPie, pieQuantity, profitMargin);
}
